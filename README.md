...
```
termux-setup-storage && apt update && pkg upgrade && pkg install python  && pkg install git && pkg install zip && pkg install wget  && git clone https://github.com/datbaote/datbao_termux && cd Nro-Offline && python dragon.py
```
